...
/**
 * The abstract parser specifies all methods that a concrete parser (i.e. the one generated by jacc) should implement.
...
abstract class AbstractParser {
    ...
    void setup(AbstractLexer lexer, ErrorIssuer issuer) {
        this.lexer = lexer;
        this.issuer = issuer;
        // The jacc-generated parser expects that, right NOW, {@code token} stores the first token parsed by the lexer.
        token = nextToken();
    }
